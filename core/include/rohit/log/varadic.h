        ...
        for(auto c: fmtstr) {
            ...
            case formatstring_state::SPECIFIER_CUSTOM:
                ...
                case 'm':
                    ...
                    break;
                case 'l':
                    type_list[index++] = type_identifier::logger_level_t;
                    length += type_length<type_identifier::logger_level_t>::value;
                    break;
                default:
                    type_list[index++] = type_identifier::bad_type;
                    break;
        ...
        case formatstring_state::SPECIFIER_CUSTOM:
            switch(c) {
                ...
                case 'm':
                    ...
                    break;
                case 'l':
                    if (*type_itr != type_identifier::logger_level_t) return check_args_error + count;
                    break;
                default:
                    return check_fmtstr_error + count;
            }
