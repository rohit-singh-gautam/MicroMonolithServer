...
template <http_header::CODE code, typecheck::byte CHAR_TYPE, size_t message_size>
constexpr CHAR_TYPE *http11_error_html(
    ...
    constexpr CHAR_TYPE str4[] =
        "<hr><address> Micro Monolith Server at ";
    ...
    buffer += to_string<number_case_t::upper, false>(local_address, (char *)buffer);
