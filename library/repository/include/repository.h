...
public:
    Container(listener::listener_t *listner, const std::filesystem::path &path) : listner { listner }, ref { rohit::json::Parse(ReadStringFromFile(path)) } { }
